import 'bloc/new_open_one_bloc.dart';
import 'models/new_open_one_model.dart';
...
class NewOpenOneScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<NewOpenOneBloc>(
        create: (context) => NewOpenOneBloc(
            NewOpenOneState(newOpenOneModelObj: NewOpenOneModel()))
          ..add(NewOpenOneInitialEvent()),
        child: NewOpenOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<NewOpenOneBloc, NewOpenOneState>(
  ...
  onTapCrossone4(BuildContext context) {
