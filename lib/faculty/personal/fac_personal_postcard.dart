...
class facultyPersonalPost extends StatefulWidget {
  ...
  @override
  State<facultyPersonalPost> createState() => _facultyPersonalPostState();
}

class _facultyPersonalPostState extends State<facultyPersonalPost> {
