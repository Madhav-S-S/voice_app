import 'bloc/personal_page_one_bloc.dart';
import 'models/personal_page_one_model.dart';
...
class PersonalPageOneScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<PersonalPageOneBloc>(
        create: (context) => PersonalPageOneBloc(PersonalPageOneState(
            personalPageOneModelObj: PersonalPageOneModel()))
          ..add(PersonalPageOneInitialEvent()),
        child: PersonalPageOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PersonalPageOneBloc, PersonalPageOneState>(
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      decoration: AppDecoration.fillCyan900.copyWith(borderRadius: BorderRadiusStyle.customBorderTL12),
  ...
  onTapBackbuttonwhite1(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.studentHomeContainerScreen,
    );
  }

  onTapEditwhitebutton1(BuildContext context) {
    NavigatorService.pushNamed(
