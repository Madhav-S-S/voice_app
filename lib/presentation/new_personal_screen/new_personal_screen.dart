import 'bloc/new_personal_bloc.dart';
import 'models/new_personal_model.dart';
...
class NewPersonalScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<NewPersonalBloc>(
        create: (context) => NewPersonalBloc(
            NewPersonalState(newPersonalModelObj: NewPersonalModel()))
          ..add(NewPersonalInitialEvent()),
        child: NewPersonalScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<NewPersonalBloc, NewPersonalState>(
  ...
  onTapCrossone2(BuildContext context) {
